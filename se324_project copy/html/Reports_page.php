...
<div class="app-wrap">
  <div class="drawer drawer-rail" id="sidebar">
    ...
    <div class="drawer-content">
      ...
      <a href="manager/ManagerMain.php" class="nav-item">
      ...
      <a href="manager/ManageCourses.php" class="nav-item">
        <div class="nav-prepend">
      ...
      <a href="manager/ManageTa.php" class="nav-item">
        <div class="nav-prepend">
      ...
      <div class="main-content" id="mainContent">
        <div class="page-header">
          ...
          <ul class="breadcrumbs">
            <li><a href="manager/ManagerMain.php">Home ></a></li>
            <li>View Reports & Analytics
            </li>
          </ul>
        </div>
