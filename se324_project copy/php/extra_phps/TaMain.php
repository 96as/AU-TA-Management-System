...
$tables = ['ta_course', 'activecourses', 'courses', 'tas'];
...
<div class="app-wrap">
  ...
  <div class="drawer drawer-rail" id="drawer">
    ...
    <div class="drawer-content">
      ...
      <a href="TaMain.php" class="nav-item">
      ...
      <div class="main-content" id="mainContent">
        <div class="page-header">
          ...
          <ul class="breadcrumbs">
            <li><a href="TaMain.php">Home ></a></li>
            <li>My Courses</li>
          </ul>
          <h2>Welcome, <?php echo htmlspecialchars($_SESSION['ta_name']); ?></h2>
        </div>
                ...
                <div class="card-title">
                  <div class="d-col">
                    ...
                    <div class="text-sub">
                      ...
                      <span>Instructor: <?= htmlspecialchars($course['instructor_name'] ?? 'N/A') ?></span>
                    </div>
